...
import { helmetConfig, mongoSanitizer, xssSanitizer,
         suspiciousRequestGuard, requestSizeGuard } from './middlewares/security.middleware.js';
...
app.use('/api/v1/orders/webhook/razorpay',
